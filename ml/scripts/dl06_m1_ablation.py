...
기준선 (machine-learning M06/M11, 2022+2023 병합 · MIN_SUPPORT=10 · 19클래스)
...
def coarsen(v):
    """m06_support_type.coarsen() 과 동일 로직."""
...
def make_groups(sub):
    """program_stem 이 있는 행은 같은 그룹으로 묶는다(M11/M12 와 동일 로직)."""
