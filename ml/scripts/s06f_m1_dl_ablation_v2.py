"""S06F — 지원성격 19클래스 분류: KLUE-RoBERTa 파인튜닝 + Ablation (모델 1 재학습).
...
기준선 (machine-learning S05A/S04B, 2022+2023 병합 · MIN_SUPPORT=10 · 19클래스)
...
def make_groups(sub):
    """program_stem 이 있는 행은 같은 그룹으로 묶는다(S04B/S04C 와 동일 로직)."""
