...
import common as C
from m13_m3_anomaly import (CAT_FEATS, MIN_AXES, NUM_FEATS, SRC, inject_synthetic,
                            prepare)
...
def main():
    ...
    C.save_report("m16_m3_ocsvm_tuning.json", {
...
def write_md(out, final, cal, verdict, scaler, feat, nu, gamma):
    ...
    for r in verdict["reasons"]:
        L.append("- %s" % r)
    L.append("")
    p = C.report_path("m16_m3_ocsvm_tuning.md")
