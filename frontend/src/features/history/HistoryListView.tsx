            ...
            >
                {histories.map((item, index) => (
                    <li
                        ...
                        className={`flex items-center gap-md py-md px-md hover:bg-surface-container-low transition-all cursor-pointer group rounded-lg ${
                            index === 0 ? 'border-t border-b border-outline-variant/30' : 'border-b border-outline-variant/30'
                        }`}
                    >
                        <div className="flex flex-col min-w-0">
                            <h4 className="font-semibold text-sm text-on-surface truncate mb-xs group-hover:text-primary transition-colors">
                                {item.title}
                            </h4>
                            <div className="flex items-center gap-xs">
                                <span className="material-symbols-outlined text-[14px] text-on-surface-variant/70">schedule</span>
